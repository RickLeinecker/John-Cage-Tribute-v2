...
const __dirname = "/home/danny/John-Cage-Tribute-v2/Website";
...
io.on("connection", function (socket) {
    ...
    // This is the stream
    socket.on("audio", (audioData) => console.log(audioData));
    ...
    io.emit("Welcome to the server!");
})

// Reusing snippets of code from the old website:
