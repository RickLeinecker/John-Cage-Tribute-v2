...
function getChannel(project = "-", site, channelId) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const res = yield apiClient.get(`/projects/${project}/sites/${site}/channels/${channelId}`);
            return res.body;
        }
        catch (e) {
            if (e.status === 404) {
...
function listChannels(project = "-", site) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (;;) {
            try {
                const res = yield apiClient.get(`/projects/${project}/sites/${site}/channels`, { queryParams: { pageToken: nextPageToken, pageSize: 10 } });
...
function createChannel(project = "-", site, channelId, ttlMillis = expireUtils_1.DEFAULT_DURATION) {
    return __awaiter(this, void 0, void 0, function* () {
        const res = yield apiClient.post(`/projects/${project}/sites/${site}/channels?channelId=${channelId}`, { ttl: `${ttlMillis / 1000}s` });
        return res.body;
    });
}
...
function updateChannelTtl(project = "-", site, channelId, ttlMillis = ONE_WEEK_MS) {
    return __awaiter(this, void 0, void 0, function* () {
        const res = yield apiClient.patch(`/projects/${project}/sites/${site}/channels/${channelId}`, { ttl: `${ttlMillis / 1000}s` }, { queryParams: { updateMask: ["ttl"].join(",") } });
        return res.body;
    });
}
...
function deleteChannel(project = "-", site, channelId) {
    return __awaiter(this, void 0, void 0, function* () {
        yield apiClient.delete(`/projects/${project}/sites/${site}/channels/${channelId}`);
    });
}
exports.deleteChannel = deleteChannel;
function cloneVersion(site, versionName, finalize = false) {
    return __awaiter(this, void 0, void 0, function* () {
        const res = yield apiClient.post(`/projects/-/sites/${site}/versions:clone`, {
