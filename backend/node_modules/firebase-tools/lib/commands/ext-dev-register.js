...
exports.default = new command_1.Command("ext:dev:register")
    ...
    yield askUserForConsent_1.promptForPublisherTOS();
    ...
    const publisherId = yield prompt_1.promptOnce({
        name: "publisherId",
        type: "input",
        message: msg,
        default: projectId,
    ...
    try {
        yield extensionsApi_1.registerPublisherProfile(projectId, publisherId);
    }
    catch (err) {
        if (err.status === 409) {
