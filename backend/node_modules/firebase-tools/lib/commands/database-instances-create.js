...
exports.default = new command_1.Command("database:instances:create <instanceName>")
    ...
    const defaultDatabaseInstance = yield getDefaultDatabaseInstance_1.getDefaultDatabaseInstance({ project: projectId });
    ...
    const instance = yield database_1.createInstance(projectId, instanceName, location, database_1.DatabaseInstanceType.USER_DATABASE);
