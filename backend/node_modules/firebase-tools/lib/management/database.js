...
function createInstance(projectId, instanceName, location, databaseType) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
...
function checkInstanceNameAvailable(projectId, instanceName, databaseType, location) {
    var _a, _b, _c;
    return __awaiter(this, void 0, void 0, function* () {
        if (!location) {
        ...
        try {
            yield api.request("POST", `/${MGMT_API_VERSION}/projects/${projectId}/locations/${location}/instances?databaseId=${instanceName}&validateOnly=true`, {
                auth: true,
                origin: api.rtdbManagementOrigin,
                timeout: TIMEOUT_MILLIS,
                data: {
