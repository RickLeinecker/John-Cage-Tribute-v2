...
class Uploader {
    ...
    wait() {
        return __awaiter(this, void 0, void 0, function* () {
            yield Promise.all([this.hashQueue.wait(), this.populateQueue.wait(), this.uploadQueue.wait()]);
        });
    }
    statusMessage() {
    ...
    populateHandler(batch) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield this.hashClient.post(`/${this.version}:populateFiles`, { files: batch });
    ...
    uploadHandler(toUpload) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const res = yield this.uploadClient.request({
                method: "POST",
                path: `/${toUpload}`,
            ...
            if (res.status !== 200) {
                logger.debug(`[hosting][upload] ${this.hashMap[toUpload]} (${toUpload}) HTTP ERROR ${res.status}: ${res.response.headers} ${yield res.response.text()}`);
