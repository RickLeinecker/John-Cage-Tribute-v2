...
class FunctionsEmulator {
                ...
                if (definition.httpsTrigger) {
                    ...
                    switch (service) {
                        case constants_1.Constants.SERVICE_FIRESTORE:
                            added = yield this.addFirestoreTrigger(this.args.projectId, key, definition.eventTrigger);
                            break;
                        case constants_1.Constants.SERVICE_REALTIME_DATABASE:
                            added = yield this.addRealtimeDatabaseTrigger(this.args.projectId, key, definition.eventTrigger);
                            break;
                        case constants_1.Constants.SERVICE_PUBSUB:
                            added = yield this.addPubsubTrigger(definition.name, key, definition.eventTrigger, definition.schedule);
                            break;
    ...
    addPubsubTrigger(triggerName, key, eventTrigger, schedule) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                yield pubsubEmulator.addTrigger(topic, key);
                return true;
            }
            catch (e) {
                return false;
    ...
    handleBackgroundTrigger(projectId, triggerKey, proto) {
        return __awaiter(this, void 0, void 0, function* () {
