...
function formatDescription(extensionName, projectId, roles) {
...
function retrieveRoleInfo(role) {
    return __awaiter(this, void 0, void 0, function* () {
        const res = yield iam.getRole(role);
        return `- ${res.title} (${res.description})`;
    });
}
exports.retrieveRoleInfo = retrieveRoleInfo;
function prompt(extensionName, projectId, roles) {
    return __awaiter(this, void 0, void 0, function* () {
        if (!roles || !roles.length) {
            return;
        }
        const message = yield formatDescription(extensionName, projectId, roles);
        ...
        const consented = yield prompt_1.promptOnce(question);
        if (!consented) {
...
function promptForPublisherTOS() {
    return __awaiter(this, void 0, void 0, function* () {
