...
function publishExtensionVersionFromLocalSource(publisherId, extensionId, rootDirectory) {
    return __awaiter(this, void 0, void 0, function* () {
        const extensionSpec = yield localHelper_1.getLocalExtensionSpec(rootDirectory);
        ...
        const consent = yield confirmExtensionVersion(publisherId, extensionId, extensionSpec.version);
        if (!consent) {
            return;
        }
        let extension;
        try {
            extension = yield extensionsApi_1.getExtension(`${publisherId}/${extensionId}`);
        }
        catch (err) {
        }
        if (extension &&
        ...
        try {
            uploadSpinner.start();
            objectPath = yield archiveAndUploadSource(rootDirectory, exports.EXTENSIONS_BUCKET_NAME);
        ...
        try {
            ...
            res = yield extensionsApi_1.publishExtensionVersion(ref, packageUri);
        ...
        yield deleteUploadedSource(objectPath);
        return res;
    });
}
...
function deleteUploadedSource(objectPath) {
    return __awaiter(this, void 0, void 0, function* () {
...
function confirmExtensionVersion(publisherId, extensionId, versionId) {
    return __awaiter(this, void 0, void 0, function* () {
...
function getSourceOrigin(sourceOrVersion) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            yield resolveSource_1.resolveRegistryEntry(sourceOrVersion);
            return SourceOrigin.OFFICIAL_EXTENSION;
        }
        catch (_a) {
        }
...
function confirmInstallInstance() {
    return __awaiter(this, void 0, void 0, function* () {
