...
class Contests extends Table {
  ...
  IntColumn get recordingIdFirst =>
      integer().references(Recordings, #recordingId)();
  IntColumn get recordingIdSecond =>
      integer().references(Recordings, #recordingId)();
  IntColumn get recordingIdThird =>
      integer().references(Recordings, #recordingId)();
}

@DriftDatabase(tables: [Accounts, UserRecordings, Recordings, Contests])
